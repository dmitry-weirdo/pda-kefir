	...
	protected Action getAction() {
		return new InitiableAction()
		{
			public void doAction() throws Exception {
				...
				// выгружаются все записи -> выставить начало в 0, лимит — в общее количество записей  
				...
				writeToExcel(testEntitys, sortConfig.getEntityName(), FILE_NAME);
			}
		};
	}

	public static final String FILE_NAME = "testEntitys";
}