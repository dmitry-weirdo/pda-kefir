...
public class ClassAnnotation
{
	...
	/**
	 * @param indent начальный отступ аннотации. Ќа этот отступ будет отсто€ть от начала строки заркывающа€ скобка параметров аннотации.
	 * @return значение аннотации, отформатированное по кодстайлу и оттабленное указанным отступом.
	 * ¬начале отступ не ставитс€ (ибо сама аннотаци€ может быть параметром другой аннотации.
	 * ѕеренос строки в конце не ставитс€, ибо после закрывающей скобки может быть нужна зап€та€
	 */
	...
	/**
	 *  раткое им€ класса аннотации
	 */
	private String annotationClass;

	/**
	 * ≈сли не <code>null</code>, то в toString пишетс€ аннотаци€ с параметрами один в строчку с указанным отступом
	 */
	private String indent = null;

	/**
	 * ≈сли <code>true</code>, то при выравненном написании все непосредственно вложенные хэши
	 * будут отформатированы, вне зависимости от их {@linkplain #indent свойства indent}.
	 */
	private boolean alignChildren = false;

	private List<String> keys; // сохран€ет ключи в пор€дке их добавлени€
