...
public class ComboBoxEntityCreateServlet extends JsonServlet
{
	protected Action getAction() {
		return new InitiableAction()
		{
			public void doAction() throws Exception {
				...
				ComboBoxEntity comboBoxEntity = fromJson(ComboBoxEntity.class);
				service.createComboBoxEntity(comboBoxEntity);

				writeSuccess(comboBoxEntity);
			}
		};
	}
}