...
//            delete record.form;
	 ...
	 * @private
	 */
	,fireFinishEvents:function(options, o) { // o added by pda
		if(true !== this.eventsSuspended && !this.singleUpload) {
			this.fireEvent('filefinished', this, options && options.record, o); // o added by pda
		}
...
//        var form = record.form;
	...
	,uploadCallback:function(options, success, response) {
		...
		this.fireFinishEvents(options, o); // o added by pda
	...
	,uploadFile:function(record, params) {
		...
		// add index of record in store as "index" param for load request (added by pda)
		Ext.apply(o.params, { index: this.store.indexOf(record) });  
