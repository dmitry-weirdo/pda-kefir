...
public class ComboBoxEntityDataProvider extends AbstractDataProvider
{
	@DataProvider(name = DATA_PROVIDER_NAME)
	public static Iterator<Object[]> loadData() {
		return new ComboBoxEntityDataProvider().loadDataFromJson(VO_DATA_FILE);
	}
	...
	private static final Class<? extends JsonObject> ENTITY_CLASS = ComboBoxEntity.class;
	private static final String VO_DATA_FILE = "ComboBoxEntity.json";

	public static final String DATA_PROVIDER_NAME = "ComboBoxEntity";
}
